...
//                        print("Found next bus at", DateUtils.dateToStr(dateObj: busTimeObj))
    ...
    func updateTimeLeft(busTime: Date?) {
        // I do not know how to fix the below issue
        // I want the phone to auto-update the schedule and reload tableview once it hits 4/8 but it can't
        //I might need a background app refresh
//         Fetch new JSON data by running saveData() on 2019/4/8
//        currUserTime = Date()
//        if count < 1 && currUserTime >= DateUtils.strToDate(str:"2019/04/08 00:00")!{
//            // reload once saveData() has finished
//            DispatchQueue.main.async {
//                let group = DispatchGroup()
//                group.enter()
//                DataUtils.saveData()
...
//    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if(bus["type"].stringValue == "28"){
            busDetailArray.append("直行")
        }
